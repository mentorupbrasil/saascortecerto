export function LandingHeroPreview() {
  return (
    <div className="relative mx-auto w-full max-w-[420px] sm:max-w-[520px] lg:max-w-none">
      ...
      <div className="relative overflow-hidden rounded-2xl border border-border bg-card shadow-[0_24px_60px_-20px_rgba(0,0,0,0.15)]">
        <div className="flex items-center gap-2 border-b border-border px-5 py-3">
          ...
          <span className="ml-2 text-[11px] text-zinc-600 tracking-wide">cortzo.app/agenda</span>
        </div>
        ...
        <div className="p-4 sm:p-5 space-y-3 sm:space-y-4">
          <div className="flex items-end justify-between">
            <div>
              ...
              <p className="font-display text-2xl text-foreground mt-1">Quinta, 26</p>
            </div>
            <div className="text-right">
              <p className="text-[10px] text-zinc-600 uppercase tracking-wider">Faturamento</p>
              <p className="text-lg font-medium text-foreground tabular-nums">R$ 840</p>
            </div>
          </div>
          ...
          <div className="relative h-36 rounded-xl border border-border bg-muted overflow-hidden">
            ...
            {[
              ...
              >
                ...
                <p className="text-[9px] text-foreground truncate">{block.name}</p>
              </div>
            ))}
          </div>

          <div className="flex gap-2">
            <div className="flex-1 rounded-lg border border-border bg-white/[0.02] px-3 py-2">
